        ...
        children: [
          Container(
            ...
            child: Icon(
              ...
              color: isDark ? colors.primary : const Color(0xFF21765A),
              size: 20,
            ),
          ),
          const Spacer(),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: _cardDecoration(context).copyWith(
        border: Border.all(
          color: isDark ? colors.outline : const Color(0xFFD9D7F2),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
...
class _Photo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? colors.primaryContainer : const Color(0xFFEDECFB),
...
BoxDecoration _cardDecoration(BuildContext context) {
  ...
  return BoxDecoration(
    ...
    border: Border.all(
      color: isDark ? theme.colorScheme.outline : const Color(0xFFE3E5EC),
    ),
    borderRadius: BorderRadius.circular(20),
    boxShadow: [
      BoxShadow(
        color: isDark ? const Color(0x28000000) : const Color(0x0B20243B),
        blurRadius: 24,
