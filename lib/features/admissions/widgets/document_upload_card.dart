...
class DocumentUploadCard extends StatelessWidget {
  ...
  final Set<StudentDocumentRequirement> requirements;
            ...
            children: requirements
                .map(
                  (item) => (
                    item.label,
                    switch (item) {
                      StudentDocumentRequirement.studentPhoto =>
                        Icons.photo_camera_outlined,
                      StudentDocumentRequirement.aadhaarCard =>
                        Icons.badge_outlined,
                      StudentDocumentRequirement.addressProof =>
                        Icons.home_outlined,
                      StudentDocumentRequirement.parentId =>
                        Icons.family_restroom_outlined,
                      StudentDocumentRequirement.collegeId =>
